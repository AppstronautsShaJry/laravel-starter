...
<html lang="en" dir="ltr" data-nav-layout="vertical" class="light" data-header-styles="light" data-menu-styles="dark" data-width="fullwidth">
    ...
    <head>
        ...
        <meta name="Description" content="Starterkit Tailwind Responsive Admin Web Dashboard Template">
        ...
        <!-- TITLE -->
        <title> Starterkit - Laravel Tailwind CSS Premium Admin & Dashboard Template </title>
