        ...
        <ul class="header-content-right">
            ...
            <li class="header-element cart-dropdown hs-dropdown ti-dropdown [--auto-close:inside]">
                ...
                <div class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden" data-popper-placement="none">
                                ...
                                <div class="flex-auto">
                                    <div class="flex items-center justify-between mb-0">
                                        <div class="mb-0 text-[14px] font-medium">
                                            <a href="javascript:void(0);">Wireless Headphones</a>
                                            <div class="truncate">
                                                <p
                        ...
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center cart-dropdown-item gap-4">
                                ...
                                <div class="flex-auto">
                                    <div class="flex items-center justify-between mb-0">
                                        <div class="mb-0 text-[14px] font-medium">
                                            <a href="javascript:void(0);">Ladies Hand Bag</a>
                                            <div class="truncate">
                                                <p
                                                    class="mb-0 header-cart-text truncate text-[11px] text-textmuted dark:text-textmuted/50">
                        ...
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center cart-dropdown-item gap-4">
                                ...
                                <div class="flex-auto">
                                    <div class="flex items-center justify-between mb-0">
                                        <div class="mb-0 text-[14px] font-medium">
                                            <a href="javascript:void(0);">Advanced Smart Watch</a>
                                            <div class="truncate">
                                                <p
                                                    class="mb-0 header-cart-text truncate text-[11px] text-textmuted dark:text-textmuted/50">
                    ...
                    <div class="p-4 empty-header-item border-t grid items-center">
                        <a href="javascript:void(0);" class="ti-btn ti-btn-primary btn-wave text-center">Proceed to
                            checkout</a>
                    </div>
                    ...
                    <ul class="list-none mb-0" id="header-notification-scroll">
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center">
                                ...
                                <div class="grow flex items-center justify-between">
                                    <div>
                                        <p class="mb-0 font-medium"><a href="javascript:void(0);">New Messages</a></p>
                                        <div
                        ...
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center">
                                ...
                                <div class="grow flex items-center justify-between">
                                    <div>
                                        <p class="mb-0 font-medium"><a href="javascript:void(0);">Order Updates</a></p>
                                        <div
                                            class="text-textmuted dark:text-textmuted/50 font-normal text-xs header-notification-text truncate">
                        ...
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center">
                                ...
                                <div class="grow flex items-center justify-between">
                                    <div>
                                        <p class="mb-0 font-medium"><a href="javascript:void(0);">Comment on Post</a></p>
                                        <div
                                            class="text-textmuted dark:text-textmuted/50 font-normal text-xs header-notification-text truncate">
                        ...
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center">
                                ...
                                <div class="grow flex items-center justify-between">
                                    <div>
                                        <p class="mb-0 font-medium"><a href="javascript:void(0);">Follow Request</a></p>
                                        <div
                                            class="text-textmuted dark:text-textmuted/50 font-normal text-xs header-notification-text truncate">
                        ...
                        <li class="ti-dropdown-item block">
                            <div class="flex items-center">
                                ...
                                <div class="grow flex items-center justify-between">
                                    <div>
                                        <p class="mb-0 font-medium"><a href="javascript:void(0);">Exclusive Offers</a></p>
                                        <div
                                            class="text-textmuted dark:text-textmuted/50 font-normal text-xs header-notification-text truncate">
            ...
            <li class="header-element ti-dropdown hs-dropdown">
                ...
                <ul class="main-header-dropdown hs-dropdown-menu ti-dropdown-menu pt-0 overflow-hidden header-profile-dropdown hidden"
                    ...
                    <li><a class="ti-dropdown-item flex items-center" href="javascript:void(0);"><i
                    ...
                    <li class="border-t border-defaultborder dark:border-defaultborder/10 bg-light"><a
                            class="ti-dropdown-item flex items-center" href="javascript:void(0);"><i
